...
HD_PWD='/tp/xph3app/xph3app604/Projet_3A/Vivado/project_noeud_seul/project_noeud_seul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ring_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ring_top.tcl -notrace
