...
HD_PWD='/tp/xph3app/xph3app604/Projet_3A/Vivado/project_noeud_seul/project_noeud_seul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ring_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ring_top.tcl
