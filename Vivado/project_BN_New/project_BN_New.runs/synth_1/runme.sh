...
HD_PWD='/tp/xph3app/xph3app604/Projet_3A/Vivado/project_BN_New/project_BN_New.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPBN_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPBN_top.tcl
