...
HD_PWD='/tp/xph3app/xph3app604/Projet_3A/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_cna.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_cna.tcl -notrace
