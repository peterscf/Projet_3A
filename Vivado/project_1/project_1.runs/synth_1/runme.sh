...
HD_PWD='/tp/xph3app/xph3app604/Projet_3A/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_cna.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_cna.tcl
